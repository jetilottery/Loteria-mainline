define([
    ...
    var logoDiv;
    var logoDivWidth = 670;
    var logoDivHeight = 217;
    var logoDivTop = 44;
    var logoDivLeft = 145;

    var progressBarDivHeightSign = 0;
    var progressBarDivWidth = 564;
    var progressBarDivHeight = 88;
//    var progressDivWidth = 510;
    var progressDivHeight = 42;
    var progressDivLeft = -3;
    var progressDivTop = 25;
...
function checkScreenMode() {
    ...
    function onLoadDone() {
        ...
        progressDiv.style.height = progressDivHeight + "px";
        progressDiv.style.left = progressDivLeft + "px";
        progressDiv.style.top = progressDivTop + "px";
